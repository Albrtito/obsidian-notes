...
# ridge regression
> [!info] Intro: 
> A regression model that uses regularization based on the magnitude of the parameters. Adding the following expression to the cost calculation:
> $$
> \alpha \sum^D_{j=1}\theta_{j}^2
>$$
> **where:**
