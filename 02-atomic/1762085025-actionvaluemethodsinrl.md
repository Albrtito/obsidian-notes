...
We always have the choice to do so of course. If we do and we always take the better choice we'll be doing **explotation** while if we don't always choose it then the agent will be more **exploring** than exploiting. 
