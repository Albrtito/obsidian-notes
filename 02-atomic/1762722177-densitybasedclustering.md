...
# density-based clustering
> [!info] Intro: 
> A clustering approach ased on connectivity and density functions. Clusters are seen as **dense regions** in the data space, separated by regions of **lower density**. 
> 
